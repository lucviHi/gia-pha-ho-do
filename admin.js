(function () {
  ...
  const DEFAULT_HISTORY = `Gia phả họ Đỗ là nơi lưu giữ ký ức về nguồn cội và hành trình nối tiếp của nhiều thế hệ. Mỗi cái tên trong gia phả không chỉ đại diện cho một con người, mà còn gợi lại một mái nhà, một nếp sống và một phần câu chuyện được truyền từ đời trước sang đời sau. Qua thời gian, có những điều được ghi chép đầy đủ, cũng có những chi tiết chỉ còn trong lời kể của người lớn tuổi. Vì vậy, bản lịch sử này được xem như một tài liệu sống để con cháu cùng đọc, cùng đối chiếu và tiếp tục hoàn thiện.

Từ thuở đầu hình thành, các gia đình trong dòng họ đã coi trọng tình thân, lòng hiếu kính và sự gắn bó giữa các thế hệ. Người đi trước gây dựng gia đình, chăm lo cuộc sống và trao lại cho con cháu không chỉ tài sản vật chất mà còn là nền nếp ứng xử. Đó là sự kính trọng ông bà, yêu thương cha mẹ, hòa thuận giữa anh chị em và tinh thần nâng đỡ nhau khi gặp khó khăn. Những giá trị ấy không nằm trong một lời răn riêng biệt, mà được thể hiện qua cách mỗi gia đình tổ chức việc nhà, chăm sóc người già, nuôi dạy trẻ nhỏ và gìn giữ các dịp sum họp.

Khi các thế hệ ngày càng đông, dòng họ dần phát triển thành nhiều chi và nhiều nhánh. Mỗi nhánh có hành trình riêng, có người ở lại quê hương, có người đi xa học tập, làm việc và lập nghiệp. Khoảng cách địa lý khiến việc gặp gỡ không còn thường xuyên như trước, nhưng nguồn gốc chung vẫn là sợi dây kết nối mọi người. Gia phả giúp từng thành viên nhận biết mình thuộc nhánh nào, quan hệ với những người khác ra sao và vị trí của mình trong toàn bộ cây gia đình. Nhờ đó, những người trẻ dù sinh ra ở xa vẫn có thể tìm hiểu về cội nguồn và nhận ra mối liên hệ giữa mình với các thế hệ đã qua.

Trong đời sống của dòng họ, việc tưởng nhớ tổ tiên có ý nghĩa đặc biệt. Ngày giỗ là dịp con cháu hướng về người đã khuất, nhắc lại công lao của tiền nhân và gặp gỡ những người cùng huyết thống. Mâm cơm tưởng niệm có thể giản dị, nhưng chứa đựng lòng biết ơn và ý thức rằng cuộc sống hôm nay được tiếp nối từ bao thế hệ trước. Việc ghi lại ngày giỗ theo âm lịch giúp gia đình thuận tiện tra cứu, chuẩn bị và nhắc nhau về những ngày quan trọng. Đây cũng là dịp để người lớn kể lại chuyện cũ, giúp con trẻ hiểu hơn về gia đình bằng những câu chuyện gần gũi.

Bên cạnh tên tuổi và ngày tháng, lịch sử dòng họ còn được tạo nên từ những ký ức đời thường. Đó có thể là câu chuyện về một người sống nhân hậu, một gia đình vượt qua giai đoạn khó khăn, một lời dạy được nhiều thế hệ nhắc lại hoặc một phong tục vẫn được gìn giữ trong ngày lễ, Tết. Những điều tưởng nhỏ bé ấy lại giúp chân dung tổ tiên trở nên gần gũi hơn. Vì vậy, khi bổ sung gia phả, mỗi gia đình có thể ghi lại câu chuyện, ảnh cũ, giấy tờ, kỷ vật và lời kể đáng nhớ. Các tư liệu ấy cần được chú thích rõ nguồn để người đọc sau này biết thông tin đến từ đâu.

Việc biên soạn gia phả đòi hỏi sự cẩn trọng và tôn trọng sự thật. Có những tên gọi được ghi theo tên húy, tên tự, tên hiệu hoặc cách gọi quen thuộc trong gia đình. Có những mốc thời gian chưa thống nhất giữa lời kể và giấy tờ. Khi gặp thông tin chưa rõ, điều phù hợp nhất là giữ nguyên dấu vết, ghi chú rằng nội dung cần xác minh và tiếp tục hỏi thêm những người am hiểu. Không nên tự suy đoán hoặc xóa bỏ một chi tiết chỉ vì chưa tìm được lời giải. Chính những khoảng trống ấy có thể trở thành gợi ý để thế hệ sau tìm lại sổ cũ, bia mộ, ảnh, thư từ và các nguồn tư liệu khác.

Ngày nay, việc số hóa gia phả mở ra một cách gìn giữ thuận tiện hơn. Thay vì để thông tin nằm rải rác trong nhiều cuốn sổ hoặc phụ thuộc hoàn toàn vào trí nhớ, cây gia phả trực tuyến giúp các thành viên ở nhiều nơi cùng xem và tra cứu. Khi phát hiện sai sót, người quản trị có thể đối chiếu rồi cập nhật; khi một gia đình có thêm thành viên mới, nhánh tương ứng có thể được bổ sung. Công nghệ giúp việc lưu giữ dễ dàng hơn, nhưng giá trị cốt lõi vẫn nằm ở sự đóng góp có trách nhiệm của mỗi người và sự đồng thuận của gia đình đối với những thông tin quan trọng.

Trang lịch sử này không nhằm kể một câu chuyện đã hoàn tất. Trái lại, đây là điểm khởi đầu để các thế hệ cùng góp nhặt những mảnh ký ức còn lại. Người lớn tuổi có thể chia sẻ điều mình từng nghe và từng chứng kiến. Người trẻ có thể hỗ trợ ghi chép, chụp lại tư liệu, sắp xếp thông tin và kết nối các nhánh đang sinh sống ở xa. Mỗi đóng góp, dù chỉ là sửa đúng một tên gọi hay bổ sung một bức ảnh, đều giúp câu chuyện chung trở nên rõ ràng hơn.

Lịch sử dòng họ Đỗ sẽ tiếp tục được viết bằng chính cuộc sống của các thế hệ hôm nay. Điều quý giá không chỉ là biết dòng họ có bao nhiêu đời, mà còn là hiểu mình đang kế thừa điều gì và muốn trao lại điều gì cho người đến sau. Mong rằng gia phả sẽ trở thành nơi con cháu có thể trở về để tìm hiểu nguồn cội, tưởng nhớ tổ tiên, nhận biết họ hàng và nuôi dưỡng sự gắn kết. Khi mỗi người dành một phần quan tâm cho lịch sử chung, ký ức gia đình sẽ không dừng lại ở quá khứ mà tiếp tục sống trong hiện tại và được trao truyền đến mai sau.`;
  const blankData = () => ({ edits: {}, added: [], deleted: [], history: { title: "Lịch sử dòng họ Đỗ", content: DEFAULT_HISTORY } });
  let data = blankData();
  let session = null;
  let applying = false;
  let applyTimer = null;
  ...
  style.textContent = `
    ...
    .gp-parent-node,.gp-parent-node>details,.gp-parent-node>details>ul,.gp-original-root,.gp-original-root>details{box-sizing:border-box;width:100%!important;max-width:none!important}.gp-parent-node>details>summary,.gp-original-root>details>summary{position:relative!important;text-align:center!important;justify-content:center!important}.gp-parent-node>details>summary>.gene-main,.gp-original-root>details>summary>.gene-main{box-sizing:border-box;width:100%!important;text-align:center!important;padding-left:34px!important;padding-right:34px!important}.gp-parent-node>details>summary>.branch-toggle,.gp-original-root>details>summary>.branch-toggle{position:absolute!important;left:18px!important;top:50%!important;transform:translateY(-50%)!important}.gp-original-root>details>summary .spouse{box-sizing:border-box;width:max-content;max-width:calc(100% - 68px);margin-left:auto!important;margin-right:auto!important;text-align:center!important}.gp-parent-node>details>ul{display:block!important;grid-template-columns:none!important;margin:14px 0 0!important;padding:0!important;border-left:0!important}.gp-parent-node>details>ul>.gp-original-root:before{display:none!important}.gp-original-root>details>summary{max-width:720px;margin:0 auto;background:#922f25!important;border:3px double #e7c99f!important}.gp-original-root>details>summary .gene-main>strong,.gp-original-root>details>summary .gene-main>small,.gp-original-root>details>summary .gene-main>em,.gp-original-root>details>summary .spouse b,.gp-original-root>details>summary .spouse small{color:#fff!important}.gene-root details[open]>summary>.gene-toggle{font-size:0!important}.gene-root details[open]>summary>.gene-toggle:after{content:"−";font:700 15px/1 Arial}.gp-original-root>details>ul{display:block!important;box-sizing:border-box;width:min(960px,100%)!important;margin:18px auto 0!important;padding:0!important;border-left:0!important}.gp-original-root>details>ul>li{box-sizing:border-box;width:100%!important;min-width:0!important;margin:12px 0!important}.gp-original-root>details>ul>li:before{display:none!important}.gp-original-root>details>ul>li>details>summary{box-sizing:border-box;width:100%!important;max-width:none!important;min-height:0!important;height:auto!important}.gp-original-root>details>ul>li details>ul{box-sizing:border-box;margin-left:18px!important;padding-left:20px!important}.gp-original-root>details>ul>li details>ul>li:before{width:19px!important;left:-20px!important}.gp-original-root>details>ul>li details>summary{box-sizing:border-box;width:100%;min-width:0;max-width:none!important}@media(max-width:700px){.gp-original-root>details>ul>li details>ul{margin-left:9px!important;padding-left:12px!important}.gp-original-root>details>ul>li details>ul>li:before{width:11px!important;left:-12px!important}}
    ...
    .gp-history-section{scroll-margin-top:88px;display:grid;grid-template-columns:minmax(210px,.7fr) minmax(0,1.6fr);gap:64px;padding:82px max(7vw,28px);background:#f7efe1;border-top:1px solid #d7c09c;border-bottom:1px solid #d7c09c;color:#3b2a22;font-family:Arial,"Helvetica Neue",sans-serif!important;font-kerning:normal;letter-spacing:normal!important;word-spacing:normal!important}.gp-history-section *{letter-spacing:normal;word-spacing:normal}.gp-history-heading .eyebrow{margin:0 0 14px;color:#9a3025;font-family:Arial,"Helvetica Neue",sans-serif;font-size:12px;font-weight:700;line-height:1.4;letter-spacing:.12em!important;text-transform:uppercase}.gp-history-heading h2{margin:0;color:#35251e;font-family:Arial,"Helvetica Neue",sans-serif!important;font-size:clamp(34px,4vw,56px);font-weight:700;line-height:1.12}.gp-history-body{border-left:3px solid #bd8740;padding:4px 0 4px 30px}.gp-history-content p{margin:0 0 16px;color:#5d493d;font-family:Arial,"Helvetica Neue",sans-serif!important;font-size:17px;font-weight:400;line-height:1.75;text-align:justify;text-rendering:optimizeLegibility}.gp-history-content p:last-child{margin-bottom:0}.gp-history-edit{margin-top:22px;border:1px solid #8f2f25;background:#8f2f25;color:#fff;padding:9px 15px;font:600 12px Arial;cursor:pointer}.gp-history-edit:hover{background:#6f251d}@media(max-width:720px){.gp-history-section{grid-template-columns:1fr;gap:28px;padding:52px 24px}.gp-history-body{padding-left:20px}.gp-history-content p{font-size:16px;text-align:left}}
  `;
  ...
  function renderHistory() {
    ...
    const historyLink=nav?.querySelector('a[href="#lichsu"]');
    if(historyLink&&!historyLink.dataset.gpScroll){historyLink.dataset.gpScroll="1";historyLink.addEventListener("click",e=>{e.preventDefault();history.replaceState(null,"","#lichsu");section.scrollIntoView({behavior:"smooth",block:"start"});});}
