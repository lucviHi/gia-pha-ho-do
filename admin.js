(function () {
  ...
  style.textContent = `
    ...
    .gp-parent-node,.gp-parent-node>details,.gp-parent-node>details>ul,.gp-original-root,.gp-original-root>details{box-sizing:border-box;width:100%!important;max-width:none!important}.gp-parent-node>details>summary{position:relative!important;text-align:center!important;justify-content:center!important}.gp-parent-node>details>summary>.gene-main{box-sizing:border-box;width:100%!important;text-align:center!important;padding-left:34px!important;padding-right:34px!important}.gp-parent-node>details>summary>.branch-toggle{position:absolute!important;left:18px!important;top:50%!important;transform:translateY(-50%)!important}.gp-parent-node>details>ul{display:block!important;grid-template-columns:none!important;margin:14px 0 0!important;padding:0!important;border-left:0!important}.gp-parent-node>details>ul>.gp-original-root:before{display:none!important}.gp-original-root>details>summary{max-width:520px;margin:0 auto;background:#922f25!important;border:3px double #e7c99f!important}.gp-original-root>details>summary .gene-main>strong,.gp-original-root>details>summary .gene-main>small,.gp-original-root>details>summary .gene-main>em,.gp-original-root>details>summary .spouse b,.gp-original-root>details>summary .spouse small{color:#fff!important}@media(min-width:950px){.gp-original-root>details>ul{display:grid!important;grid-template-columns:repeat(5,minmax(0,1fr))!important;gap:12px;width:100%!important;margin:18px 0 0!important;padding:0!important;border-left:0!important}.gp-original-root>details>ul>li{min-width:0!important}.gp-original-root>details>ul>li:before{display:none}.gp-original-root>details>ul>li>details>summary{box-sizing:border-box;width:100%;height:100%;min-height:112px;padding:10px}.gp-original-root>details>ul>li .gene-main>strong{font-size:15px}}
